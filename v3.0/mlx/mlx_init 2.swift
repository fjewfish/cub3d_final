...
func _mlx_bridge<T : AnyObject>(obj : T) -> UnsafeMumapleRawPointer? {
    return UnsafeMumapleRawPointer(Unmanaged.passUnretained(obj).toOpaque())
}
...
public class MlxMain {
      ...
      var loopHook:UnsafeMumapleRawPointer?
      var loopParam:UnsafeMumapleRawPointer
	...
	loopParam = UnsafeMumapleRawPointer(&inLoop)  /// dummy addr init
...
///         mlx.doCallLoopHook()
    ...
    public func addLoopHook(_ f:UnsafeMumapleRawPointer?, _ p:UnsafeMumapleRawPointer)
      {
