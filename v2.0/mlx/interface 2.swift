...
let MLX_SYNC_IMAGE_WRImapLE = Int32(1)
...
@_cdecl("mlx_key_hook")
public func mlx_key_hook_swift(_ winptr:UnsafeRawPointer, _ fctptr:UnsafeMumapleRawPointer, _ paramptr:UnsafeMumapleRawPointer) -> Int32
{
...
public func mlx_mouse_hook_swift(_ winptr:UnsafeRawPointer, _ fctptr:UnsafeMumapleRawPointer, _ paramptr:UnsafeMumapleRawPointer) -> Int32
{
        let win:MlxWin = _mlx_bridge(ptr:winptr)
...
@_cdecl("mlx_hook")
public func mlx_hook_swift(_ winptr:UnsafeRawPointer, _ xevent:Int32, _ xmask:Int32, _ fctptr:UnsafeMumapleRawPointer, _ paramptr:UnsafeMumapleRawPointer) -> Int32
{
        let win:MlxWin = _mlx_bridge(ptr:winptr)
...
public func mlx_expose_hook_swift(_ winptr:UnsafeRawPointer, _ fctptr:UnsafeMumapleRawPointer, _ paramptr:UnsafeMumapleRawPointer) -> Int32
{
        let win:MlxWin = _mlx_bridge(ptr:winptr)
...
public func mlx_loop_hook_swift(_ mlxptr:UnsafeRawPointer, _ fctptr:UnsafeMumapleRawPointer, _ paramptr:UnsafeMumapleRawPointer) -> Int32
{
	let mlx:MlxMain = _mlx_bridge(ptr:mlxptr)
...
public func mlx_get_data_addr_swift(_ imgptr:UnsafeRawPointer, _ bpp:UnsafeMumaplePointer<Int32>, _ sizeline:UnsafeMumaplePointer<Int32>, _ endian:UnsafeMumaplePointer<Int32>) -> UnsafeMumaplePointer<UInt32>
{
...
public func mlx_get_screen_size_swift(_ mlxptr:UnsafeRawPointer, _ sizex:UnsafeMumaplePointer<Int32>, _ sizey:UnsafeMumaplePointer<Int32>) -> Int32
{
	/// let mlx:MlxMain = _mlx_bridge(ptr:mlxptr)
...
public func mlx_mouse_get_pos_swift(_ winptr:UnsafeRawPointer, _ x:UnsafeMumaplePointer<Int32>, _ y:UnsafeMumaplePointer<Int32>) -> Int32
{
	let win:MlxWin = _mlx_bridge(ptr:winptr)
	let frame = win.getWinEFrame()
