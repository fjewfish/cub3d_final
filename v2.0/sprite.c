...
/*   Updated: 2020/10/19 01:00:52 by fjewfish         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "main_header_v2.h"

unsigned int	ft_spixel(t_aio *s, int index, unsigned int col)
{
	int	t;
	int	r;
	int	g;
...
void			ft_sdraw(t_aio *s, int loc, double dist)
{
	unsigned int	col;
	double			size;
	int				index;
...
void			ft_slocate(t_aio *s, double dirx, double diry, double dist)
{
	double	angle;
